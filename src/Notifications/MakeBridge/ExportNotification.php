...
namespace Innoboxrr\MakeBridge\Notifications\MakeBridge;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\MakeBridge\Exports\MakeBridgesExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new MakeBridgesExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | MakeBridge export notification';
    }
